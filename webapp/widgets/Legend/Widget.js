...
_WidgetsInTemplateMixin, BaseWidget, LayerInfos, Legend) {
  ...
  var clazz = declare([BaseWidget, _WidgetsInTemplateMixin], {
    ...
    onOpen: function() {
      ...
      if (curTab=="SE" && curDisplayValuePos==0) { //TOTAL
        pos.width = iLegendWidth_SE_Total;
      } else if (curTab=="SE" && curDisplayValuePos==1) { //DENSITY
        pos.width = iLegendWidth_SE_Density;
      } else if (curTab=="VOL") {
        pos.width = iLegendWidth_VOL;
      } else if (curTab=="RTP") {
        pos.width = iLegendWidth_RTP;
      }
